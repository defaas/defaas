<?php
    ...
    $merchantOrderId = 'A89JK568T'; // from merchant, unique
    ...
    $callbackUrl = "http://defaas.herokuapp.com/callBackUrl.php"; // url for callback
    $returnUrl = "http://defaas.herokuapp.com/returnUrl.php"; // url for redirect
